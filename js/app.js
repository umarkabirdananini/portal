...
const TRACK_WEBHOOK_URL = "https://script.google.com/macros/s/AKfycbxxutbvu4XUEr_Tb01s07-fV7fsZJgPyzHHexEytzW6qlJK1FOarq4uAuen98nU6R4dyw/exec"; // e.g. "https://script.google.com/macros/s/XXXX/exec"
...
function printSlip(){
  ...
  // iPhone-friendly printing: open a clean print view page
  try{
    sessionStorage.setItem("SLIP_HTML", buildSlipHTML(currentRecord));
  }catch(e){}

  // Open print view (user can Share → Print on iPhone)
